...
DOCKER_REPO = "meldingen_vooronderzoek-dev"
ELASTIC_IMAGE = "geosolutions/elasticsearch-plugins"
ELASTIC_CONTAINER_NAME = "meldingen_vooronderzoek-elastic-init"
ELASTIC_DATA = "$(pwd)/data/elastic"
STORAGE_PROVIDER_IMAGE = "meldingen_vooronderzoek-dev/storageprovider:latest"
STORAGE_PROVIDER_CONTAINER_NAME = "storageprovider-init"
STORAGE_PROVIDER_DATA = "$(pwd)/data/storageprovider"
STORAGE_PROVIDER_DATA_MAP = "{}:/meldingen_vooronderzoek_store".format(STORAGE_PROVIDER_DATA)
REDIS_IMAGE = "redis"
REDIS_CONTAINER_NAME = "meldingen_vooronderzoek-redis-init"
...
def start_redis():
    ...
    _exec_command("docker run "
                  "--link {}:redis "
                  "meldingen_vooronderzoek-dev/redis-checker:latest"
...
def start_storage_provider():
    ...
    _exec_command("docker run "
                  ...
                  "meldingen_vooronderzoek-dev/storageprovider-checker:latest"
...
def start_elastic():
    ...
    _exec_command("docker run "
                  "--link {}:elastic "
                  "meldingen_vooronderzoek-dev/elastic-checker:latest"
