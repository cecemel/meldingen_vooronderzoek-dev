...
DATABASE_IMAGE = "meldingen_vooronderzoek-dev/postgres:latest"
DATABASE_CONTAINER_NAME = "meldingen_vooronderzoek-migration-db"
...
def start_db():
    ...
    time.sleep(10)
    _exec_command("docker run --link {}:postgres meldingen_vooronderzoek-dev/postgres-checker:latest".format(DATABASE_CONTAINER_NAME))
